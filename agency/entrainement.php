...
?>
    <div class="container">
        <div class="row">
            ...
            <h3>Les Lundis, Mercredis et Jeudi : </h3>
            <ul>
                <li>de 17 heures 30 à 18 heures 30 pour les enfants débutants</li>
                <li>de 18 h 15 à 19 h 30 pour les moyens</li>
                <li>de 18 heures 30 à 20 heures pour les plus grands et les confirmés</li>
            </ul>
            <h3>Les Jeudis : </h3>
            <ul><li>de 20 heures à 21 heures 30 pour les adultes épéistes</li></ul>
