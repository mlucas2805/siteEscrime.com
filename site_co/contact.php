...
<div class="col-lg-5 col-lg-push-3 ">
            ...
            <form action="phpfile.php"  method="post" class="contact" style="margin-top: 10px">         
                <fieldset class="contact-inner" style="padding-bottom: 45px">
                    ...
                    <p required type="text" class="contact-input" autofocus value="">
                        <label for="select" class="select">
                            <select name="membre" id="select">
                                <option value="" selected >Membre du syndicat à contacter</option>'
                                <?php
                                $sql = 'SELECT membres_syndic_tbl.id_membre_syndic,membres_syndic_tbl.id_user,nom,prenom
                                ...
                                while($ligne = $requete->fetch(PDO::FETCH_OBJ)){
                                    ...
                                    echo '<option value="'.utf8_encode($ligne->nom).'">'.utf8_encode($ligne->nom).' '.utf8_encode($ligne->prenom).'</option></div>'
                                    ;
